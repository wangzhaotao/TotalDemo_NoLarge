...
@interface WTLocationVC ()<MKMapViewDelegate>
{
...
@implementation WTLocationVC

- (void)viewDidLoad {
    [super viewDidLoad];
    //
    [self checkLocatioState];
    [self initUI];
...
-(BOOL) checkLocatioState{
    
    __weak typeof(self) weak_self = self;
    [WTLocationManager locationWith:^(BOOL suc, NSArray * _Nonnull locs) {
