...
-(void)viewWillAppear:(BOOL)animated {
    ...
    [[BCNewGuidePageManager share]showWithFrame:[UIScreen mainScreen].bounds type:GuidePageType_Device];
}

-(void)onClick:(UIButton*)sender {
    
    WTGuidePage2VC *vc = [WTGuidePage2VC new];
...
-(void)initUI {
    ...
    UIButton *nextBtn=[IProUtil commonTextBtn:iBFont(dp2po(17)) color:[UIColor whiteColor] title:@"Already Connected"];
